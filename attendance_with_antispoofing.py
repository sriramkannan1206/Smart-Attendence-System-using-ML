...
def login():
            ...
            if row == None:
                ...
                def manage_employee():
                    try:
                        ...
                        background_pic.pack()
                        first.title("Manage Staff post")
                        print("Hi Sriram Captain")
                        face = Label(first, text = "Management of a Staff" , bg = "pink" , fg = "white", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 5, relief = RIDGE).place(x = 500, y = 10)
    ...
    ######################################### Function to recognize the face
                ...
                manage = 'Smart Attendance System'
                topic = Label(attendance, text = manage , bg = "white" , fg = "black", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 5, relief = RIDGE)
                topic.place (x = 0, y = 0,relwidth = 1)
                # faceslider()
                # faceslidercolor()

                photo1 = PhotoImage(file = "Photos/management.png", master = attendance)
                B1 = Button(attendance, image = photo1, text = "Employee Management",font = ("Times New Roman" , 15), fg = "green", height =230, width = 260, command = manage_employee, compound = BOTTOM )
                B1.place(x = 20, y = 120)
